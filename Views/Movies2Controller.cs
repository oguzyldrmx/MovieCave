...
namespace MovieCave.Views
{
    public class Movies2Controller : Controller
    {
        ...
        public Movies2Controller(ApplicationDbContext context, IWebHostEnvironment hostingEnvironment)
        {
            _context = context;
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            ViewData["CategoriesId"] = new SelectList(_context.Categories, "Id", "Id", movies.CategoriesId);
            return View(movies);
        }
